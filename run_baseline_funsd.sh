...
CONFIG_NAME="memory32-"   
export WANDB_PROJECT="FUNSD-${CONFIG_NAME}"

SEEDS=(42 123 1993)

for SEED in "${SEEDS[@]}"
do
    OUT="./output/funsd-${CONFIG_NAME}-seed${SEED}"

    echo ""
    echo "============================================================"
    echo "FUNSD ${CONFIG_NAME} (LAYOUTLMV3-BASE)"
    echo "SEED = ${SEED}"
    echo "============================================================"
...
for seed in seeds:
    path = "./output/funsd-{}-seed{}/eval_results.json".format(config_name, seed)
    print("\nSeed {}:".format(seed))
...
output_summary_file = "funsd_{}_3seed_summary.json".format(config_name)
