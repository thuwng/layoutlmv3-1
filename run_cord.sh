...
CONFIG_NAME="memory32-layer10"   
export WANDB_PROJECT="CORD-${CONFIG_NAME}"

SEEDS=(42 123 1993)

for SEED in "${SEEDS[@]}"
do
    OUT="./output/cord-${CONFIG_NAME}-seed${SEED}"

    echo ""
    echo "============================================================"
    echo "CORD ${CONFIG_NAME} (LAYOUTLMV3-BASE)"
    echo "SEED = ${SEED}"
    echo "============================================================"
...
echo ""
echo "============================================================"
echo "CALCULATING ${CONFIG_NAME} 3-SEED MEAN ± STD"
echo "============================================================"
...
for seed in seeds:
    path = "./output/cord-{}-seed{}/eval_results.json".format(config_name, seed)
    print("\nSeed {}:".format(seed))
...
print("\n" + "=" * 70)
print("FINAL {} RESULT: MEAN ± STD".format(config_name))
print("=" * 70)
...
output_summary_file = "cord_{}_3seed_summary.json".format(config_name)
